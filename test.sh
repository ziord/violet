...
assert() {
  ...
  echo "$input" | ./target/debug/violet -o ./tmp/out.asm - || exit
...
assert 47 'int main() { return  12 + 34 - 5 + 6;}'
...
assert 15 'int main() { int a = 3; int z = 5; return a *z; }'
assert 3 'int main() { int foo = 3; return foo; }'
assert 8 'int main() { int foo123 = 3; int bar = 5; return foo123+bar; }'
assert 13 'int main() { int foo123 = 3, bar = 5; return foo123+ bar *foo123 - bar; }'
...
assert 4 'int main() { int x[3]; *x=3; *(x+1)=4; *(x+2)=5; return *(x) + *(x+2) - *(x+1); }'
